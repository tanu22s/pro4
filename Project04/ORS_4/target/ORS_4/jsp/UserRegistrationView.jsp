...
<body>
	<jsp:useBean id="bean" class="in.co.rays.ors.bean.UserBean"
			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="login"
						placeholder="Enter vallid Email-Id" size="25"
				...
				<tr>
					...
					<td><input type="text" name="dob" id="udate"
						readonly="readonly" size="25" placeholder="Greater then 18 year"
